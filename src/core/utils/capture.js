...
export function captureToBlobs(tab, callback, errback, progress, splitnotifier) {
  var loaded = false,
    screenshots = [],
    timeout = 3000,
    timedOut = false,
...
export function captureToFiles(tab, filename, callback, errback, progress, splitnotifier) {
